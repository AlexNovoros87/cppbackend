...
public:
    ...
    //метод GetRandomField, принимающий генератор случайных чисел. 
    //Используется для инициализации поля игрока.
    template <class T>
...
public:
   ...
   //произвести выстрел по сектору: получить результат выстрела. 
   //Используется для своего поля при выстреле соперника.
    ...
    //Отметить результат выстрела. Используется для поля соперника.
