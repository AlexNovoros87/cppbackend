...
struct LogConst{
    ...
    static constexpr const boost::json::string_view data = "data";
    static constexpr const boost::json::string_view timestamp = "timestamp";
    static constexpr const boost::json::string_view code = "code";
    };
   
   struct Req{
   Req() = delete;
   static constexpr const boost::json::string_view request_received = "request received";
   static constexpr const boost::json::string_view ip = "ip";
   static constexpr const boost::json::string_view URI = "URI";
   static constexpr const boost::json::string_view  method = "method";
   };
   
   struct Resp{
   Resp() = delete;
   static constexpr const boost::json::string_view response_sent  = "response sent";
   static constexpr const boost::json::string_view response_time = "response_time";
   static constexpr const boost::json::string_view content_type = "content_type";
   static constexpr const boost::json::string_view null = "null";
   };
   
   struct Run{
   Run()= delete;
   static constexpr const boost::json::string_view port = "port";
   static constexpr const boost::json::string_view address = "address";
   static constexpr const boost::json::string_view server_started = "server started";
   };
 
   struct Stop{
   Stop() = delete;
   static constexpr const boost::json::string_view server_exited = "server exited";
   static constexpr const boost::json::string_view exception = "exception";
   
   };
 
   struct Err{
   Err() = delete;
   static constexpr const boost::json::string_view error = "error";
   static constexpr const boost::json::string_view text = "text";
   static constexpr const boost::json::string_view where = "where";
   static constexpr const boost::json::string_view read = "read";
   static constexpr const boost::json::string_view write = "write";
   static constexpr const boost::json::string_view accept = "accept";
   };
