...
namespace model
{
    ...
    std::vector<std::shared_ptr<Road>> OnWhichRoadsLoot(const GameSession &game, LootCoordinates coordy, const SessionGraph &graph){
         return OnWhichRoadsDod(game, coordy, graph);
    };
